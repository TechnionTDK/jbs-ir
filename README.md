...
The tool allows you to automate the evaluation of the engine by:
...
3. Enabling the "explain other" options - allows the user to get debug information of a specific document, even if this document not in the retrieved results 
